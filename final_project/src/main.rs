...
use pmcp::tools::{calculator_tool, analyze_complexity_tool, extract_files_tool, deep_analysis_tool};
...
async fn main() -> anyhow::Result<()> {
    ...
    info!("Server configured with {} tools", server.capabilities().tools.len());
